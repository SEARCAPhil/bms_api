...
$specs_tr = '';
foreach ($requirements_profile[$id][0]->specs as $key => $value) {
  $specs_tr.="<tr>
                <td>{$value->name}</td>
                <td>{$value->value}</td>
              </tr>";
  ...
  <tbody>
    <tr>
      <td valign="top" align="center" class="specbundle">
            ...
            <p style='margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'><span class="specbundle2"><span class="font1">Price Inquiry</span></span></p>


            <p style='margin:0;font-family:Georgia,Time,sans-serif;font-size:12px;color:red;'><span class="specbundle2"><span class="font1"> Deadline : {$requirements_profile[$id][0]->deadline}</span></span></p>
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div>
                                  <p>
                                    <h2><b>{$requirements_profile[$id][0]->name}</b> ({$requirements_profile[$id][0]->quantity} {$requirements_profile[$id][0]->unit})</h2><br/>
                                  </p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p>
                                    Gentleman : We solicit your lowest price, fastest delivery, and payment terms for the item/s
                                    specified below and in strict accordance with the specification/s given. Any deviation in the
                                    specification/s must be covered by your detailed description of the substitution offered.
                                    Your price should be quoted properly.<br/><br/>\n
                                    It must be clearly understood that this is not an order but is an inquiry by us and that
                                    therefore there will be no contract between us unless and until any quotation so given by
                                    you is accepted by us in writing.                  
                                  </p>
                                </div>
                              </div>
                            </td>
